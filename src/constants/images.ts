...
export const TOP_WEEK_PLAYLIST = require('../assets/images/home_sections/top_week_playlist.png')
export const NEW_PLAYLIST = require('../assets/images/home_sections/new_playlist.png')
